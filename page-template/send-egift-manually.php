...
<script type="text/javascript">
    jQuery(".u-contact-submit").click(function (e) {
        ...
        var email = jQuery('#send-bonuscard').find('input[name="email"]').val();
        ...
        if (cardnumber != "" && regcode != "" && amount != "" && order_id !="") {
            ...
            jQuery.ajax({
                ...
                data: {action: 'send_egift_manually', cardnumber: cardnumber, regcode: regcode, amount: amount, order_id: order_id, email: email},
    ...
    jQuery(".u-contact-submit-no-val").click(function (e) {
        ...
        if (cardnumber != "" && regcode != "" && amount != "" && order_id !="") {
            ...
            jQuery.ajax({
                type: "POST",
                url: "<?php echo admin_url('admin-ajax.php'); ?>",
                data: {action: 'send_egift_manually_no_val', cardnumber: cardnumber, regcode: regcode, amount: amount, order_id: order_id, email: email},
                success: function (data)
                {
                    $(".error-form-no-val").html("");
                    var response = JSON.parse(data);
