                                            ...
                                            <tr>
                                                ...
                                                <td width="600">
                                                    <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                                ...
                                                                <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            ...
                                                                            ?>
                                                                            <img src="<?php echo $card_image; ?>" data-img="" alt="A gift for you; an eCard from Texas de Brazil!" style="border-radius: 7px; display: block;width: 80%;">
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        ...
                                                        <?php
                                                        //if (self::get_is_gift_card() || $isgiftcard == 'Yes'): 
                                                        //var_dump([$isgiftcard,$isGiftCardItem]);

                                                        if ('Yes' == self::get_is_gift_card() || 'Yes' == $isGiftCardItem):
                                                            ?>
