                ...
                <meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0; user-scalable=no;">
                    <meta http-equiv="X-UA-Compatible" content="IE=9; IE=8; IE=7; IE=EDGE">
                        ...
                        <body style="padding: 0;margin: 0;background-color: #FFFBF5;size-adjust: 100%;-ms-text-size-adjust: 100%;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;width: 100% !important;">
                            <?php if (!empty($showPdfLinks)) include (get_template_directory() . '/emails/partials/email_vip_card_preview.php'); ?>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="border-collapse: collapse;">
                                                                                        ...
                                                                                        <table cellpadding="0" cellspacing="0" bgcolor="#000000" style="width:95%;margin:auto;">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><div style="padding:10px;text-align: center;color:white;font-size: 20px; line-height: 24px;">Valid from 3/4/24 to 10/31/24</div></td>
                                                                                            </tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="text-align:center;">
                                                                                                    ...
                                                                                                    <a href="<?php echo home_url(); ?>/wp-content/uploads/2024/02/VIP-Card-Rules-of-Use-600x422.jpg" target="blank">
                                                                                                        <img src="<?php echo home_url(); ?>/wp-content/uploads/2024/02/VIP-Card-Rules-of-Use-600x422.jpg" 
