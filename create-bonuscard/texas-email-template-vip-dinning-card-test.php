                ...
                <meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0; user-scalable=no;">
                    <meta http-equiv="X-UA-Compatible" content="IE=9; IE=8; IE=7; IE=EDGE">
                        ...
                        <body style="padding: 0;margin: 0;background-color: #FFFBF5;size-adjust: 100%;-ms-text-size-adjust: 100%;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;width: 100% !important;">
                            <table border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto; padding: 0;width:696px;">
                                <tr>
                                    <td align="center" valign="top" style="border-collapse: collapse;">
                                        <table width="696" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p" style="width: 696px;margin: auto;">
                                            <tr>
                                                ...
                                                <td width="600">
                                                    <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                                ...
                                                                <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            ...
                                                                            <img src="<?php echo home_url(); ?>/wp-content/uploads/2021/03/TDB-February2021-VIP-Card-Campaign-Instagram-Graphic-1080x1080-FINAL-02-copy-600x431.png" alt="A gift for you; an eCard from Texas de Brazil!" style="border-radius: 7px; display: block;max-width: 480px;width: 100%;">
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        ...
                                                        <?php if ('Yes' == self::get_is_gift_card()): ?>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                                        <tr>
                                                                            <td align="center">
                                                                                <span style="color: #141415; font-size: 32px; line-height: 38px; font-weight: bold;"><?php echo self::get_user_name(); ?></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="center">
                                                                        ...
                                                                        <tr>
                                                                            <td align="center">
                                                                                <span style="color: #8C908E; font-size: 20px; line-height: 32px; font-weight: 300; letter-spacing: 1.5px;">From: <?php echo get_post_meta(self::$orderId, '_billing_first_name', true) . ' ' . get_post_meta(self::$orderId, '_billing_last_name', true); ?></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="center">
                                                                                <span style="color: #000; font-size: 20px; line-height: 32px; font-weight: 300; letter-spacing: 1.5px;padding-top: 15px;display: block;"><?php echo self::get_user_message(); ?></span>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                            ...
                                                                            <table width="600" cellpadding="0" cellspacing="0" bgcolor="#000000" class="100p">
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="border-collapse: collapse;">
                                                                                        ...
                                                                                        <table cellpadding="0" cellspacing="0" bgcolor="#000000" style="width:95%;margin:auto;">
                                                                                            <tr>
                                                                                            ...
                                                                                            <tr style="text-align:center;">
                                                                                                ...
                                                                                                <td>
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <span style="color: #FFFFFF; font-size: 25px; line-height: 24px;text-align:center;">VIP CARD NUMBER</span>
                                                                                                    </div>
                                                                                                    <div>
                                                                                            ...
                                                                                            <tr style="text-align:center;">
                                                                                                ...
                                                                                                <td>
                                                                                                    ...
                                                                                                    <span style="color: #FFFFFF; font-size: 20px; line-height: 24px; text-transform: uppercase;text-align:center;" >12 Uses</span>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><div style="padding:10px;text-align: center;color:white;font-size: 20px; line-height: 24px;">Valid from 3/1/23 to 10/31/23</div></td>
                                                                                            </tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="text-align:center;">
                                                                                                    ...
                                                                                                    <a href="<?php echo home_url(); ?>/wp-content/uploads/2023/02/VIP-Dining-Card-ROU-2023-V2-768x536.png" target="blank">
                                                                                                        <img src="<?php echo home_url(); ?>/wp-content/uploads/2023/02/VIP-Dining-Card-ROU-2023-V2.png" 
                                                                                                             style="border-radius: 7px;display: block; max-width: 100%;margin:auto;"></a>
                                                                                            ...
                                                                                            <?php if ($showPdfLinks) { ?>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center" style="border-collapse: collapse;">
                                                                                                        <a id="saveAsPdfBtn" href="https://www.sejda.com/html-to-pdf?save-link=<?php echo $fileUrlName; ?>&viewportWidth=1440&pageSize=A4" style="display:block;">Download PDF opt 1</a>
                                                                                                        <a href="<?php echo home_url(); ?>/reservations/?download_pdf_file=<?php echo $fileUrlName; ?>" style="display:block;">Download PDF opt 2</a>
                        ...
                        <script>
                            document.getElementById('saveAsPdfBtn').addEventListener('click', function (e) {
                                var pageUrl = '<?php echo $fileUrlName; ?>';
