                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto; padding: 0;width:696px;">
                                <tr>
                                    <td align="center" valign="top" style="border-collapse: collapse;">
                                        ...
                                        <table style="max-width:696px;width:100%;" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                            <tr>
                                                <td width="48" style="border-collapse: collapse;">&nbsp;</td>
                                                <td>
                                                    <table cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                        <tr>
                                                            <td height="54" style="border-collapse: collapse;">
                                                            ...
                                                            <td>
                                                                <table cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center">
                                                                            <?php
//                                                                            $image = wp_get_attachment_image_src(get_post_thumbnail_id(self::get_card_theme()), 'full');
//                                                                            if ($image) {
//                                                                                $card_image = $image[0];
//                                                                            } else {
...
//                                                                            }
                                                                            //$card_image=site_url().'/wp-content/uploads/2020/08/e-certificate-600x378.png';
                                                                            ?>
                                                                            <img src="<?php echo $top_image; ?>" alt="A gift for you; an ecert from Texas de Brazil!" style="border-radius: 7px; display: block;width: 80%;">
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table cellpadding="0" cellspacing="0" bgcolor="#000000" class="100p">
                                                                    <tr>
                                                                        <td style="border-collapse: collapse;">


                                                                            <table cellpadding="0" cellspacing="0" bgcolor="#000000" class="100p" style="max-width:600px;">
                                                                                <tr>
                                                                                        ...
                                                                                        <table cellpadding="0" cellspacing="0" bgcolor="#000000" width="100%">
                                                                                            ...
                                                                                            <tr style="text-align:center;">
                                                                                                ...
                                                                                                <td>
                                                                                                    ...
                                                                                                    <div>
                                                                                                        <span style="color: #FFFFFF; font-size: 25px; line-height: 24px;text-align:center;">E-CERTIFICATE NUMBER</span>
                                                                                                    </div>
                                                                                                    <div>
                                                                                            ...
                                                                                            <tr style="text-align:center;">
                                                                                                ...
                                                                                                <td>
                                                                                                    ...
                                                                                                    <?php if ($amount): ?>
                                                                                                        ...
                                                                                                        <?php if ('dinner' == $form_type && $discount): ?>
                                                                                                            <span style="color: #FFFFFF; font-size: 20px; line-height: 24px; text-transform: uppercase;text-align:center;" ><span style="text-transform:lowercase">x</span><?php echo $amount; ?> <?php echo $discount; ?>% Dinner Discount</span> 
                                                                                                        <?php else: ?>
                                                                                                            <span style="color: #FFFFFF; font-size: 20px; line-height: 24px; text-transform: uppercase;text-align:center;" >$<?php echo $amount; ?></span> 
                                                                                                        <?php endif; ?>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td height="27" style="border-collapse: collapse;">
                                                                                                    <a href="<?php echo home_url(); ?>/balance" style="font-size:25px;color: white;display: block;text-align: center;margin: 0px 0px 10px 0;">CHECK BALANCE</a>
                                                                                                </td>
                                                                                            </tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="border-collapse: collapse;padding: 20px; text-align: center;color:#ffffff;font-size:20px;line-height:24px">Expires <?php echo date('m/d/y', strtotime('+ '.self::$expiration)); ?></td>
                                                                                            </tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="text-align:center;">
                                                                                                    ...
                                                                                                    <a href="<?php echo $rule_image; ?>" target="blank">
                                                                                                        <img src="<?php echo $rule_image; ?>" style="border-radius: 7px; display: block;width: 95%;margin: auto;"></a>
