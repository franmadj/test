                                                                ...
                                                                <table cellpadding="0" cellspacing="0" bgcolor="#000000" class="100p">
                                                                    <tr>
                                                                        <td style="border-collapse: collapse;">
                                                                            ...
                                                                            <table style="max-width:600px;" cellpadding="0" cellspacing="0" bgcolor="#000000" class="100p">
                                                                                <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    ...
                                                                                                    <?php if ($amount): ?>
                                                                                                        ...
                                                                                                        <?php if ('dinner' == $form_type && $discount): ?>
                                                                                                            <span style="color: #FFFFFF; font-size: 20px; line-height: 24px; text-transform: uppercase;text-align:center;" ><span style="text-transform:lowercase">x</span><?php echo $amount; ?> %<?php echo $discount; ?> Discount</span> 
                                                                                                        <?php else: ?>
...
<!--                                                                                            <tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="border-collapse: collapse;padding: 20px; text-align: center;color:#ffffff;font-size:20px;line-height:24px">Valid from 1/2/23 - 3/30/23</td>
                                                                                            </tr>
