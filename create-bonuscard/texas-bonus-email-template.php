                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                                    <tr>
                                                                        <td align="center">
                                                                            <img src="<?php echo home_url(); ?>/assets/img/updated_tdb_bonus_card.png" alt="A gift for you; an eCard from Texas de Brazil!" 
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="border-collapse: collapse;">
                                                                                        <table cellpadding="0" cellspacing="0" bgcolor="#000000" width="100%" style="padding:0 28px;">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><div style="padding:10px;text-align: center;color:white;font-size: 20px; line-height: 24px;">Valid from 1/2/23 to 4/27/23</div></td>
                                                                                            </tr>
