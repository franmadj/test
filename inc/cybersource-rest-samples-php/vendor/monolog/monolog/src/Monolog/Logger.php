...
use Psr\Logcy\LoggerInterface;
use Psr\Logcy\InvalidArgumentException;
use Psr\Logcy\LogLevel;
use Throwable;
use Stringable;
use WeakMap;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \Psr\Logcy\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  value-of<Level::VALUES>|Level $level
