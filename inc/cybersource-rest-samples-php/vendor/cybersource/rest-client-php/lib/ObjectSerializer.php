    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (Configuration::getDefaultConfiguration()->getLogConfiguration()->isLoggingEnabled()) {
                $tempLogger = (new LogFactory())->getLogger(\CyberSourceApi\Utilities\Helpers\ClassHelper::getClassName(get_class()), Configuration::getDefaultConfiguration()->getLogConfiguration());
