...
class Notificationsubscriptionsv1webhooksSecurityPolicy1 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'securityType' => 'string',
        'proxyType' => 'string',
        'config' => '\CyberSourceApi\Model\Notificationsubscriptionsv1webhooksSecurityPolicy1Config'
    ];
    ...
    /**
     * Gets config
     * @return \CyberSourceApi\Model\Notificationsubscriptionsv1webhooksSecurityPolicy1Config
     */
    ...
    /**
     * Sets config
     * @param \CyberSourceApi\Model\Notificationsubscriptionsv1webhooksSecurityPolicy1Config $config
     * @return $this
     */
