...
/**
 * InlineResponse2011SetupsPaymentsCardProcessingSubscriptionStatus Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2011SetupsPaymentsCardProcessingSubscriptionStatus implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_1_setups_payments_cardProcessing_subscriptionStatus';
    ...
    const REASON_DEPENDENT_PRODUCT_NOT_CONTRACTED = 'DEPENDENT_PRODUCT_NOT_CONTRACTED';
    const REASON_DEPENDENT_FEATURE_NOT_CHOSEN = 'DEPENDENT_FEATURE_NOT_CHOSEN';
    ...
    {
        return [
            self::REASON_DEPENDENT_PRODUCT_NOT_CONTRACTED,
            self::REASON_DEPENDENT_FEATURE_NOT_CHOSEN,
