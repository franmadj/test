...
class Boardingv1registrationsOrganizationInformationOwners implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'phoneNumber' => 'string',
        'email' => 'string',
        'address' => '\CyberSourceApi\Model\Boardingv1registrationsOrganizationInformationBusinessInformationAddress'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/[À-ÖØ-öø-ǿÀ-ÖØ-öø-ǿa-zA-Z().\\-_#,;\/\\\\@$:&amp;!?%«»€₣«»€₣ ]{1,}$/", $this->container['firstName'])) {
            $invalid_properties[] = "invalid value for 'firstName', must be conform to the pattern /[À-ÖØ-öø-ǿÀ-ÖØ-öø-ǿa-zA-Z().\\-_#,;\/\\\\@$:&amp;!?%«»€₣«»€₣ ]{1,}$/.";
        }

        if (!is_null($this->container['middleName']) && !preg_match("/[À-ÖØ-öø-ǿÀ-ÖØ-öø-ǿa-zA-Z().\\-_#,;\/\\\\@$:&amp;!?%«»€₣«»€₣ ]{1,}$/", $this->container['middleName'])) {
            $invalid_properties[] = "invalid value for 'middleName', must be conform to the pattern /[À-ÖØ-öø-ǿÀ-ÖØ-öø-ǿa-zA-Z().\\-_#,;\/\\\\@$:&amp;!?%«»€₣«»€₣ ]{1,}$/.";
        }

        if ($this->container['lastName'] === null) {
            $invalid_properties[] = "'lastName' can't be null";
        }
        if (!preg_match("/[À-ÖØ-öø-ǿÀ-ÖØ-öø-ǿa-zA-Z().\\-_#,;\/\\\\@$:&amp;!?%«»€₣«»€₣ ]{1,}$/", $this->container['lastName'])) {
            $invalid_properties[] = "invalid value for 'lastName', must be conform to the pattern /[À-ÖØ-öø-ǿÀ-ÖØ-öø-ǿa-zA-Z().\\-_#,;\/\\\\@$:&amp;!?%«»€₣«»€₣ ]{1,}$/.";
        }
        ...
        if (!is_null($this->container['ssn']) && !preg_match("/^\\d{3}-\\d{2}-\\d{4}$|^\\d{9,9}$/", $this->container['ssn'])) {
            $invalid_properties[] = "invalid value for 'ssn', must be conform to the pattern /^\\d{3}-\\d{2}-\\d{4}$|^\\d{9,9}$/.";
        }

        if (!is_null($this->container['passportNumber']) && !preg_match("/^(?!^0+$)[a-zA-Z0-9]{3,20}$/", $this->container['passportNumber'])) {
            $invalid_properties[] = "invalid value for 'passportNumber', must be conform to the pattern /^(?!^0+$)[a-zA-Z0-9]{3,20}$/.";
        }

        if (!is_null($this->container['passportCountry']) && !preg_match("/^[À-ÖØ-öø-ǿa-zA-Z0-9().\\-_#,;\/@$:!% ]{1,}$/", $this->container['passportCountry'])) {
            $invalid_properties[] = "invalid value for 'passportCountry', must be conform to the pattern /^[À-ÖØ-öø-ǿa-zA-Z0-9().\\-_#,;\/@$:!% ]{1,}$/.";
        }

        if ($this->container['jobTitle'] === null) {
            $invalid_properties[] = "'jobTitle' can't be null";
        }
        if (!preg_match("/^[À-ÖØ-öø-ǿa-zA-Z0-9().\\-_#,;\/@$:!% ]{1,}$/", $this->container['jobTitle'])) {
            $invalid_properties[] = "invalid value for 'jobTitle', must be conform to the pattern /^[À-ÖØ-öø-ǿa-zA-Z0-9().\\-_#,;\/@$:!% ]{1,}$/.";
        }
    ...
    public function valid()
    {
        ...
        if (!preg_match("/[À-ÖØ-öø-ǿÀ-ÖØ-öø-ǿa-zA-Z().\\-_#,;\/\\\\@$:&amp;!?%«»€₣«»€₣ ]{1,}$/", $this->container['middleName'])) {
            return false;
        }
        if ($this->container['lastName'] === null) {
            return false;
        ...
        if (!preg_match("/^\\d{3}-\\d{2}-\\d{4}$|^\\d{9,9}$/", $this->container['ssn'])) {
            return false;
        }
        if (!preg_match("/^(?!^0+$)[a-zA-Z0-9]{3,20}$/", $this->container['passportNumber'])) {
            return false;
        }
        if (!preg_match("/^[À-ÖØ-öø-ǿa-zA-Z0-9().\\-_#,;\/@$:!% ]{1,}$/", $this->container['passportCountry'])) {
            return false;
        }
        if ($this->container['jobTitle'] === null) {
            return false;
    ...
    /**
     * Gets address
     * @return \CyberSourceApi\Model\Boardingv1registrationsOrganizationInformationBusinessInformationAddress
     */
    ...
    /**
     * Sets address
     * @param \CyberSourceApi\Model\Boardingv1registrationsOrganizationInformationBusinessInformationAddress $address
     * @return $this
     */
