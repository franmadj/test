...
/**
 * PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentPayouts Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentPayouts implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'paymentsProducts_cardProcessing_configurationInformation_configurations_features_cardNotPresent_payouts';
    ...
    protected static $swaggerTypes = [
        ...
        'networkOrder' => 'string',
        'currencies' => 'map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentPayoutsCurrencies]',
        'merchantId' => 'string',
        'terminalId' => 'string'
    ];
    ...
    /**
     * Gets currencies
     * @return map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentPayoutsCurrencies]
     */
    ...
    /**
     * Sets currencies
     * @param map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentPayoutsCurrencies] $currencies Three-character [ISO 4217 ALPHA-3 Standard Currency Codes.](http://apps.cybersource.com/library/documentation/sbc/quickref/currencies.pdf)
     * @return $this
     */
