...
class PaymentsProductsCardProcessingSubscriptionInformation implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'features' => 'map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingSubscriptionInformationFeatures]'
    ];
    ...
    /**
     * Gets features
     * @return map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingSubscriptionInformationFeatures]
     */
    ...
    /**
     * Sets features
     * @param map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingSubscriptionInformationFeatures] $features This is a map. The allowed keys are below. Value should be an object containing a sole boolean property - enabled. <table>    <tr>       <td>cardPresent</td>    </tr>    <tr>       <td>cardNotPresent</td>    </tr> </table>
     * @return $this
     */
