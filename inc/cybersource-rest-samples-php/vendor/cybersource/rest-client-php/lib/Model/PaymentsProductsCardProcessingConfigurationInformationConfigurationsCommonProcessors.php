...
/**
 * PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'paymentsProducts_cardProcessing_configurationInformation_configurations_common_processors';
    ...
    protected static $swaggerTypes = [
        ...
        'abaNumber' => 'string',
        'acquirer' => '\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer',
        'merchantId' => 'string',
        'terminalId' => 'string',
        'paymentTypes' => 'map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes]',
        'currencies' => 'map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1]',
        'sicCode' => 'string',
    ...
    /**
     * Gets acquirer
     * @return \CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer
     */
    ...
    /**
     * Sets acquirer
     * @param \CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer $acquirer
     * @return $this
     */
    ...
    /**
     * Gets paymentTypes
     * @return map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes]
     */
    ...
    /**
     * Sets paymentTypes
     * @param map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes] $paymentTypes Valid values are: * VISA * MASTERCARD * AMERICAN_EXPRESS * CUP * EFTPOS * DINERS_CLUB * DISCOVER * JCB
     * @return $this
     */
    ...
    /**
     * Gets currencies
     * @return map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1]
     */
    ...
    /**
     * Sets currencies
     * @param map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1] $currencies Three-character [ISO 4217 ALPHA-3 Standard Currency Codes.](http://apps.cybersource.com/library/documentation/sbc/quickref/currencies.pdf)
     * @return $this
     */
    ...
    public function setMerchantTier($merchantTier)
    {
        if (!is_null($merchantTier) && (!preg_match("/^[0-9]+$/", $merchantTier))) {
            throw new \InvalidArgumentException("invalid value for $merchantTier when calling PaymentsProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors., must conform to the pattern /^[0-9]+$/.");
        }
