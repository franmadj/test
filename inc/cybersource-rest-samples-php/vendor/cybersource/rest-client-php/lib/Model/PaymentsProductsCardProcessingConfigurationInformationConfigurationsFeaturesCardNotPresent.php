...
/**
 * PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresent Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresent implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'paymentsProducts_cardProcessing_configurationInformation_configurations_features_cardNotPresent';
    ...
    protected static $swaggerTypes = [
        'processors' => 'map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentProcessors]',
        'ignoreAddressVerificationSystem' => 'bool',
        'visaStraightThroughProcessingOnly' => 'bool',
        'amexTransactionAdviceAddendum1' => 'string',
        'installment' => '\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentInstallment'
    ];
    ...
    /**
     * Gets processors
     * @return map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentProcessors]
     */
    ...
    /**
     * Sets processors
     * @param map[string,\CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentProcessors] $processors e.g. * amexdirect * barclays2 * CUP * EFTPOS * fdiglobal * gpx * smartfdc * tsys * vero * VPC  For VPC, CUP and EFTPOS processors, replace the processor name from VPC or CUP or EFTPOS to the actual processor name in the sample request. e.g. replace VPC with &lt;your vpc processor&gt;
     * @return $this
     */
    ...
    /**
     * Gets installment
     * @return \CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentInstallment
     */
    ...
    /**
     * Sets installment
     * @param \CyberSourceApi\Model\PaymentsProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentInstallment $installment
     * @return $this
     */
