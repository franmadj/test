...
class Upv1capturecontextsOrderInformationBillTo implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'locality' => 'string',
        'postalCode' => 'string',
        'company' => '\CyberSourceApi\Model\Upv1capturecontextsOrderInformationBillToCompany',
        'email' => 'string',
        'firstName' => 'string',
        'lastName' => 'string',
        'middleName' => 'string',
    ...
    /**
     * Gets company
     * @return \CyberSourceApi\Model\Upv1capturecontextsOrderInformationBillToCompany
     */
    ...
    /**
     * Sets company
     * @param \CyberSourceApi\Model\Upv1capturecontextsOrderInformationBillToCompany $company
     * @return $this
     */
