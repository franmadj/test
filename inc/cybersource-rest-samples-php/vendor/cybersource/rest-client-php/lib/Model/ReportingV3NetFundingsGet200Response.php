...
class ReportingV3NetFundingsGet200Response implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'startTime' => '\DateTime',
        'endTime' => '\DateTime',
        'netFundingSummaries' => '\CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseNetFundingSummaries[]',
        'totalPurchases' => '\CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[]',
        'totalRefunds' => '\CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[]',
        'totalFees' => '\CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[]',
        'totalChargebacks' => '\CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[]',
        'netTotal' => '\CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[]'
    ];
     ...
     * @return \CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseNetFundingSummaries[]
     */
     ...
     * @param \CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseNetFundingSummaries[] $netFundingSummaries List of Netfunding summary objects
     * @return $this
     */
    ...
    /**
     * Gets totalPurchases
     * @return \CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[]
     */
    ...
    /**
     * Sets totalPurchases
     * @param \CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[] $totalPurchases List of total purchases currency wise
     * @return $this
     */
    ...
    /**
     * Sets totalRefunds
     * @param \CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[] $totalRefunds List of total refunds currency wise
     * @return $this
     */
    ...
    /**
     * Sets totalFees
     * @param \CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[] $totalFees List of total fees currency wise
     * @return $this
     */
     ...
     * @param \CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[] $totalChargebacks List of total chargebacks currency wise
     * @return $this
     */
    ...
    /**
     * Sets netTotal
     * @param \CyberSourceApi\Model\ReportingV3NetFundingsGet200ResponseTotalPurchases[] $netTotal List of new total currency wise
     * @return $this
     */
