...
class Ptsv2paymentsTravelInformationLodging implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'checkInDate' => 'string',
        'checkOutDate' => 'string',
        'room' => '\CyberSourceApi\Model\Ptsv2paymentsTravelInformationLodgingRoom[]',
    ...
    /**
     * Gets room
     * @return \CyberSourceApi\Model\Ptsv2paymentsTravelInformationLodgingRoom[]
     */
    ...
    /**
     * Sets room
     * @param \CyberSourceApi\Model\Ptsv2paymentsTravelInformationLodgingRoom[] $room The object containing the number of nights and the daily rate that applies for that no of nights.
     * @return $this
     */
