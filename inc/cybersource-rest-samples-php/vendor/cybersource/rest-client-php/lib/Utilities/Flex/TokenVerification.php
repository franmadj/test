...
namespace CyberSourceApi\Utilities\Flex;
...
class TokenVerification
{
    ...
    public function __construct(\CyberSourceApi\Logging\LogConfiguration $logConfig=null)
    {
        if (self::$MyLogger === null) {
            self::$MyLogger = (new LogFactory())->getLogger(\CyberSourceApi\Utilities\Helpers\ClassHelper::getClassName(get_class()), $logConfig);
        }
    }
