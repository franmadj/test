...
use CyberSourceApi\Logging\LogConfiguration as LogConfiguration;
...
class MerchantConfiguration
{
    ...
    public function __construct()
    {
        ...
        if (self::$logger === null) {
            self::$logger = (new LogFactory())->getLogger(\CyberSourceApi\Utilities\Helpers\ClassHelper::getClassName(get_class()), $this->logConfig);
        }
    }
    ...
    {
        $report  = 'PHP SDK (CyberSourceApi) Debug Report:' . PHP_EOL;
    ...
    public function validateMerchantData()
    {
        ...
        self::$logger = (new LogFactory())->getLogger(\CyberSourceApi\Utilities\Helpers\ClassHelper::getClassName(get_class()), $this->getLogConfiguration());
        ...
        $output = \CyberSourceApi\Utilities\Helpers\ListHelper::toString($configurationData);
