...
class GlobalParameter
{
	...
	const DEPRECATED_RUN_ENVIRONMENT = "The value provided for this field `RunEnvironment` has been deprecated and will not be used anymore.\n\nPlease refer to the README file [ https://github.com/CyberSourceApi/cybersource-rest-samples-php/blob/master/README.md ] for information about the new values that are accepted." . PHP_EOL;	
