...
class TransactionDetailsApi
{
     ...
     * @return array of \CyberSourceApi\Model\TssV2TransactionsGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getTransactionWithHttpInfo($id)
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\TssV2TransactionsGet200Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\TssV2TransactionsGet200Response',
                '/tss/v2/transactions/{id}'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\TssV2TransactionsGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\TssV2TransactionsGet200Response', $e->getResponseHeaders());
