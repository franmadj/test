...
class CustomerApi
{
     ...
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\TmsV2CustomersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getCustomerWithHttpInfo($customerId, $profileId = null)
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\TmsV2CustomersResponse");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\TmsV2CustomersResponse',
                '/tms/v2/customers/{customerId}'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\TmsV2CustomersResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\TmsV2CustomersResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse400', $e->getResponseHeaders());
     ...
     *
     * @param string $customerId The Id of a Customer. (required)
     * @param \CyberSourceApi\Model\PatchCustomerRequest $patchCustomerRequest  (required)
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
    ...
    public function patchCustomerWithHttpInfo($customerId, $patchCustomerRequest, $profileId = null, $ifMatch = null)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\PatchCustomerRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
     ...
     * Create a Customer
     *
     * @param \CyberSourceApi\Model\PostCustomerRequest $postCustomerRequest  (required)
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\TmsV2CustomersResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function postCustomerWithHttpInfo($postCustomerRequest, $profileId = null)
    {
        ...
        $sdkTracker = new \CyberSourceApi\Utilities\Tracking\SdkTracker();
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\PostCustomerRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
