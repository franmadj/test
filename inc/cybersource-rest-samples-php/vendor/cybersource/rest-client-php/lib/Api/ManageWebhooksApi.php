...
class ManageWebhooksApi
{
     ...
     * @param string $webhookId The webhook Identifier (required)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\InlineResponse2004, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getWebhookSubscriptionByIdWithHttpInfo($webhookId)
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\InlineResponse2004");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\InlineResponse2004',
                '/notification-subscriptions/v1/webhooks/{webhookId}'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\InlineResponse2004', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse2004', $e->getResponseHeaders());
     ...
     * @param \CyberSourceApi\Model\ReplayWebhooksRequest $replayWebhooksRequest The request query (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of void, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function replayPreviousWebhooksWithHttpInfo($webhookId, $replayWebhooksRequest = null)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\ReplayWebhooksRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
     ...
     * @param \CyberSourceApi\Model\SaveAsymEgressKey $saveAsymEgressKey Provide egress Asymmetric key information to save (create or store) (required)
     * @param string $vCCorrelationId A globally unique id associated with your request (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\InlineResponse2014, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function saveAsymEgressKeyWithHttpInfo($vCSenderOrganizationId, $vCPermissions, $saveAsymEgressKey, $vCCorrelationId = null)
    {
        ...
        $sdkTracker = new \CyberSourceApi\Utilities\Tracking\SdkTracker();
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\SaveAsymEgressKey')), $this->apiClient->merchantConfig->getRunEnvironment());
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\InlineResponse2014");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\InlineResponse2014',
                '/kms/egress/v2/keys-asym'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\InlineResponse2014', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse2014', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param string $webhookId The Webhook Identifier. (required)
     * @param \CyberSourceApi\Model\UpdateWebhookRequest $updateWebhookRequest The webhook payload or changes to apply. (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of void, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function updateWebhookSubscriptionWithHttpInfo($webhookId, $updateWebhookRequest = null)
    {
        ...
        $sdkTracker = new \CyberSourceApi\Utilities\Tracking\SdkTracker();
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\UpdateWebhookRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 404:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse4042', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
