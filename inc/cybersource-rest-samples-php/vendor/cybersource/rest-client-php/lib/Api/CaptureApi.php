...
class CaptureApi
{
     ...
     * Capture a Payment
     *
     * @param \CyberSourceApi\Model\CapturePaymentRequest $capturePaymentRequest  (required)
     ...
     * @return array of \CyberSourceApi\Model\PtsV2PaymentsCapturesPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function capturePaymentWithHttpInfo($capturePaymentRequest, $id)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\CapturePaymentRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\PtsV2PaymentsCapturesPost201Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\PtsV2PaymentsCapturesPost201Response',
                '/pts/v2/payments/{id}/captures'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\PtsV2PaymentsCapturesPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\PtsV2PaymentsCapturesPost201Response', $e->getResponseHeaders());
