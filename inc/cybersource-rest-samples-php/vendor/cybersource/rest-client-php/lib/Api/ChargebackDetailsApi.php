...
class ChargebackDetailsApi
{
     ...
     * @return array of \CyberSourceApi\Model\ReportingV3ChargebackDetailsGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getChargebackDetailsWithHttpInfo($startTime, $endTime, $organizationId = null)
    {
        ...
        if (!is_null($organizationId) && !preg_match("/[a-zA-Z0-9-_]+/", $organizationId)) {
            self::$logger->error("InvalidArgumentException : Invalid value for \"organizationId\" when calling ChargebackDetailsApi.getChargebackDetails, must conform to the pattern /[a-zA-Z0-9-_]+/.");
            throw new \InvalidArgumentException('Invalid value for \"organizationId\" when calling ChargebackDetailsApi.getChargebackDetails, must conform to the pattern /[a-zA-Z0-9-_]+/.');
        }
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\ReportingV3ChargebackDetailsGet200Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\ReportingV3ChargebackDetailsGet200Response',
                '/reporting/v3/chargeback-details'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\ReportingV3ChargebackDetailsGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\ReportingV3ChargebackDetailsGet200Response', $e->getResponseHeaders());
