...
class UnifiedCheckoutCaptureContextApi
{
     ...
     *
     * @param \CyberSourceApi\Model\GenerateUnifiedCheckoutCaptureContextRequest $generateUnifiedCheckoutCaptureContextRequest  (required)
    ...
    public function generateUnifiedCheckoutCaptureContextWithHttpInfo($generateUnifiedCheckoutCaptureContextRequest)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\GenerateUnifiedCheckoutCaptureContextRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 201:
                    ...
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse4008', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
