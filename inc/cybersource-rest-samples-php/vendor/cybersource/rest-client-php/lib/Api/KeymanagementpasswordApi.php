...
class KeymanagementpasswordApi
{
     ...
     * @param \CyberSourceApi\Model\UpdatePasswordKeysRequest $updatePasswordKeysRequest  (required)
    ...
    public function updatePasswordWithHttpInfo($keyId, $updatePasswordKeysRequest)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\UpdatePasswordKeysRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
