...
class InvoicesApi
{
     ...
     *
     * @param \CyberSourceApi\Model\CreateInvoiceRequest $createInvoiceRequest  (required)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\InvoicingV2InvoicesPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function createInvoiceWithHttpInfo($createInvoiceRequest)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\CreateInvoiceRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\InvoicingV2InvoicesPost201Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\InvoicingV2InvoicesPost201Response',
                '/invoicing/v2/invoices'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\InvoicingV2InvoicesPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InvoicingV2InvoicesPost201Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 202:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InvoicingV2InvoicesPost202Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    ...
                    break;
                case 404:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InvoicingV2InvoicesAllGet404Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                default:
     ...
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\InvoicingV2InvoicesAllGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getAllInvoicesWithHttpInfo($offset, $limit, $status = null)
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\InvoicingV2InvoicesAllGet200Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\InvoicingV2InvoicesAllGet200Response',
                '/invoicing/v2/invoices'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\InvoicingV2InvoicesAllGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InvoicingV2InvoicesAllGet200Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InvoicingV2InvoicesAllGet400Response', $e->getResponseHeaders());
     ...
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\InvoicingV2InvoicesGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getInvoiceWithHttpInfo($id)
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\InvoicingV2InvoicesGet200Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\InvoicingV2InvoicesGet200Response',
                '/invoicing/v2/invoices/{id}'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\InvoicingV2InvoicesGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InvoicingV2InvoicesGet200Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InvoicingV2InvoicesAllGet400Response', $e->getResponseHeaders());
     ...
     *
     * @param string $id The invoice number. (required)
     * @param \CyberSourceApi\Model\UpdateInvoiceRequest $updateInvoiceRequest Updating the invoice does not resend the invoice automatically. You must resend the invoice separately. (required)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\InvoicingV2InvoicesPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function updateInvoiceWithHttpInfo($id, $updateInvoiceRequest)
    {
        ...
        $sdkTracker = new \CyberSourceApi\Utilities\Tracking\SdkTracker();
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\UpdateInvoiceRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
