...
class PurchaseAndRefundDetailsApi
{
     ...
     * @param string $groupName Valid CyberSourceApi Group Name.User can define groups using CBAPI and Group Management Module in EBC2. Groups are collection of organizationIds (optional)
     ...
     * @return array of \CyberSourceApi\Model\ReportingV3PurchaseRefundDetailsGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getPurchaseAndRefundDetailsWithHttpInfo($startTime, $endTime, $organizationId = null, $paymentSubtype = 'ALL', $viewBy = 'requestDate', $groupName = null, $offset = null, $limit = '2000')
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\ReportingV3PurchaseRefundDetailsGet200Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\ReportingV3PurchaseRefundDetailsGet200Response',
                '/reporting/v3/purchase-refund-details'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\ReportingV3PurchaseRefundDetailsGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\ReportingV3PurchaseRefundDetailsGet200Response', $e->getResponseHeaders());
