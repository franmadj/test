...
class SymmetricKeyManagementApi
{
     ...
     *
     * @param \CyberSourceApi\Model\CreateSharedSecretKeysRequest $createSharedSecretKeysRequest  (required)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\KmsV2KeysSymPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function createV2SharedSecretKeysWithHttpInfo($createSharedSecretKeysRequest)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\CreateSharedSecretKeysRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\KmsV2KeysSymPost201Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\KmsV2KeysSymPost201Response',
                '/kms/v2/keys-sym'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\KmsV2KeysSymPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\KmsV2KeysSymPost201Response', $e->getResponseHeaders());
     ...
     * @param \CyberSourceApi\Model\CreateSharedSecretKeysVerifiRequest $createSharedSecretKeysVerifiRequest  (required)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\KmsV2KeysSymPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function createV2SharedSecretKeysVerifiWithHttpInfo($vIcDomain, $createSharedSecretKeysVerifiRequest)
    {
        ...
        $sdkTracker = new \CyberSourceApi\Utilities\Tracking\SdkTracker();
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\CreateSharedSecretKeysVerifiRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
     ...
     *
     * @param \CyberSourceApi\Model\DeleteBulkSymmetricKeysRequest $deleteBulkSymmetricKeysRequest  (required)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\KmsV2KeysSymDeletesPost200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function deleteBulkSymmetricKeysWithHttpInfo($deleteBulkSymmetricKeysRequest)
    {
        ...
        $sdkTracker = new \CyberSourceApi\Utilities\Tracking\SdkTracker();
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\DeleteBulkSymmetricKeysRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\KmsV2KeysSymDeletesPost200Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\KmsV2KeysSymDeletesPost200Response',
                '/kms/v2/keys-sym/deletes'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\KmsV2KeysSymDeletesPost200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\KmsV2KeysSymDeletesPost200Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse4005', $e->getResponseHeaders());
     ...
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\KmsV2KeysSymGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getKeyDetailsWithHttpInfo($keyId)
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\KmsV2KeysSymGet200Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\KmsV2KeysSymGet200Response',
                '/kms/v2/keys-sym/{keyId}'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\KmsV2KeysSymGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\KmsV2KeysSymGet200Response', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse4005', $e->getResponseHeaders());
