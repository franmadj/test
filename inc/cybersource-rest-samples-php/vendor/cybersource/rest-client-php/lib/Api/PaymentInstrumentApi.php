...
class PaymentInstrumentApi
{
     ...
     *
     * @param string $paymentInstrumentId The Id of a payment instrument. (required)
     * @param \CyberSourceApi\Model\PatchPaymentInstrumentRequest $patchPaymentInstrumentRequest  (required)
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
    ...
    public function patchPaymentInstrumentWithHttpInfo($paymentInstrumentId, $patchPaymentInstrumentRequest, $profileId = null, $ifMatch = null)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\PatchPaymentInstrumentRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
     ...
     *
     * @param \CyberSourceApi\Model\PostPaymentInstrumentRequest $postPaymentInstrumentRequest  (required)
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultPaymentInstrument, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function postPaymentInstrumentWithHttpInfo($postPaymentInstrumentRequest, $profileId = null)
    {
        ...
        $sdkTracker = new \CyberSourceApi\Utilities\Tracking\SdkTracker();
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\PostPaymentInstrumentRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
