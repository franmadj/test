...
class PaymentBatchSummariesApi
{
     ...
     * @return array of \CyberSourceApi\Model\ReportingV3PaymentBatchSummariesGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getPaymentBatchSummaryWithHttpInfo($startTime, $endTime, $organizationId = null, $rollUp = null, $breakdown = null, $startDayOfWeek = null)
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\ReportingV3PaymentBatchSummariesGet200Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\ReportingV3PaymentBatchSummariesGet200Response',
                '/reporting/v3/payment-batch-summaries'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\ReportingV3PaymentBatchSummariesGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\ReportingV3PaymentBatchSummariesGet200Response', $e->getResponseHeaders());
