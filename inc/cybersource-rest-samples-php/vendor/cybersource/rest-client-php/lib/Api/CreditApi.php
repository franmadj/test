...
class CreditApi
{
     ...
     * Process a Credit
     *
     * @param \CyberSourceApi\Model\CreateCreditRequest $createCreditRequest  (required)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\PtsV2CreditsPost201Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function createCreditWithHttpInfo($createCreditRequest)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\CreateCreditRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\PtsV2CreditsPost201Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\PtsV2CreditsPost201Response',
                '/pts/v2/credits'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\PtsV2CreditsPost201Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 201:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\PtsV2CreditsPost201Response', $e->getResponseHeaders());
