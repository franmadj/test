...
class CustomerShippingAddressApi
{
     ...
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultShippingAddress, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getCustomerShippingAddressWithHttpInfo($customerId, $shippingAddressId, $profileId = null)
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultShippingAddress");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultShippingAddress',
                '/tms/v2/customers/{customerId}/shipping-addresses/{shippingAddressId}'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultShippingAddress', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultShippingAddress', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse400', $e->getResponseHeaders());
     ...
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\ShippingAddressListForCustomer, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getCustomerShippingAddressesListWithHttpInfo($customerId, $profileId = null, $offset = '0', $limit = '20')
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\ShippingAddressListForCustomer");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\ShippingAddressListForCustomer',
                '/tms/v2/customers/{customerId}/shipping-addresses'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\ShippingAddressListForCustomer', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\ShippingAddressListForCustomer', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse400', $e->getResponseHeaders());
     ...
     * @param string $customerId The Id of a Customer. (required)
     * @param string $shippingAddressId The Id of a shipping address. (required)
     * @param \CyberSourceApi\Model\PatchCustomerShippingAddressRequest $patchCustomerShippingAddressRequest  (required)
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
    ...
    public function patchCustomersShippingAddressWithHttpInfo($customerId, $shippingAddressId, $patchCustomerShippingAddressRequest, $profileId = null, $ifMatch = null)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\PatchCustomerShippingAddressRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
     ...
     *
     * @param string $customerId The Id of a Customer. (required)
     * @param \CyberSourceApi\Model\PostCustomerShippingAddressRequest $postCustomerShippingAddressRequest  (required)
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultShippingAddress, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function postCustomerShippingAddressWithHttpInfo($customerId, $postCustomerShippingAddressRequest, $profileId = null)
    {
        ...
        $sdkTracker = new \CyberSourceApi\Utilities\Tracking\SdkTracker();
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\PostCustomerShippingAddressRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
