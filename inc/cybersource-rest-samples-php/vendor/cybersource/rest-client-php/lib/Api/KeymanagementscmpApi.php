...
/**
 * KeymanagementscmpApi Class Doc Comment
 *
 * @category Class
 * @package  CyberSourceApi
 * @author   Swagger Codegen team
...
class KeymanagementscmpApi
{
    ...
    /**
     * Operation updateSCMP
     *
     * Update or Deactivate
     *
     * @param string $keyId Key ID. (required)
     * @param \CyberSourceApi\Model\UpdatePGPKeysRequest1 $updatePGPKeysRequest  (required)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSCMP($keyId, $updatePGPKeysRequest)
    {
        self::$logger->info('CALL TO METHOD updateSCMP STARTED');
        list($response, $statusCode, $httpHeader) = $this->updateSCMPWithHttpInfo($keyId, $updatePGPKeysRequest);
        self::$logger->info('CALL TO METHOD updateSCMP ENDED');
        self::$logger->close();
        return [$response, $statusCode, $httpHeader];
    }

    /**
     * Operation updateSCMPWithHttpInfo
     *
     * Update or Deactivate
     *
     * @param string $keyId Key ID. (required)
     ...
     * @return array of object, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateSCMPWithHttpInfo($keyId, $updatePGPKeysRequest)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\UpdatePGPKeysRequest1')), $this->apiClient->merchantConfig->getRunEnvironment());
