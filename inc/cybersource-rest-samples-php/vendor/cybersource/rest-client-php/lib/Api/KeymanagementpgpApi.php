...
class KeymanagementpgpApi
{
     ...
     * @param \CyberSourceApi\Model\UpdatePGPKeysRequest $updatePGPKeysRequest  (required)
    ...
    public function updatePGPWithHttpInfo($keyId, $updatePGPKeysRequest)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\UpdatePGPKeysRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
