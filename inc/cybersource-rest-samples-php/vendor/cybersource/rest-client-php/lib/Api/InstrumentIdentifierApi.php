...
class InstrumentIdentifierApi
{
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 404:
                    ...
                    break;
                case 409:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse409', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 410:
     ...
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getInstrumentIdentifierWithHttpInfo($instrumentIdentifierId, $profileId = null)
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier',
                '/tms/v1/instrumentidentifiers/{instrumentIdentifierId}'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
     ...
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\PaymentInstrumentList, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getInstrumentIdentifierPaymentInstrumentsListWithHttpInfo($instrumentIdentifierId, $profileId = null, $offset = '0', $limit = '20')
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\PaymentInstrumentList");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath,
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\PaymentInstrumentList',
                '/tms/v1/instrumentidentifiers/{instrumentIdentifierId}/paymentinstruments'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\PaymentInstrumentList', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\PaymentInstrumentList', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 400:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse400', $e->getResponseHeaders());
     ...
     *
     * @param string $instrumentIdentifierId The Id of an Instrument Identifier. (required)
     * @param \CyberSourceApi\Model\PatchInstrumentIdentifierRequest $patchInstrumentIdentifierRequest Specify the previous transaction Id to update. (required)
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
    ...
    public function patchInstrumentIdentifierWithHttpInfo($instrumentIdentifierId, $patchInstrumentIdentifierRequest, $profileId = null, $ifMatch = null)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\PatchInstrumentIdentifierRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 410:
                    ...
                    break;
                case 412:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse412', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
                case 424:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\InlineResponse424', $e->getResponseHeaders());
     ...
     *
     * @param \CyberSourceApi\Model\PostInstrumentIdentifierRequest $postInstrumentIdentifierRequest Specify either a Card, Bank Account or Enrollable Card (required)
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultPaymentInstrumentEmbeddedInstrumentIdentifier, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function postInstrumentIdentifierWithHttpInfo($postInstrumentIdentifierRequest, $profileId = null)
    {
        ...
        $sdkTracker = new \CyberSourceApi\Utilities\Tracking\SdkTracker();
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\PostInstrumentIdentifierRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
     ...
     *
     * @param string $instrumentIdentifierId The Id of an Instrument Identifier. (required)
     * @param \CyberSourceApi\Model\PostInstrumentIdentifierEnrollmentRequest $postInstrumentIdentifierEnrollmentRequest Specify Enrollable Card details (required)
     * @param string $profileId The Id of a profile containing user specific TMS configuration. (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of void, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function postInstrumentIdentifierEnrollmentWithHttpInfo($instrumentIdentifierId, $postInstrumentIdentifierEnrollmentRequest, $profileId = null)
    {
        ...
        $sdkTracker = new \CyberSourceApi\Utilities\Tracking\SdkTracker();
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSourceApi\Model\PostInstrumentIdentifierEnrollmentRequest')), $this->apiClient->merchantConfig->getRunEnvironment());
