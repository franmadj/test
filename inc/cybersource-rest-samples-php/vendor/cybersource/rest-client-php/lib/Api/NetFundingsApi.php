...
class NetFundingsApi
{
     ...
     * @param string $groupName Valid CyberSourceApi Group Name. (optional)
     * @throws \CyberSourceApi\ApiException on non-2xx response
     * @return array of \CyberSourceApi\Model\ReportingV3NetFundingsGet200Response, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    public function getNetFundingDetailsWithHttpInfo($startTime, $endTime, $organizationId = null, $groupName = null)
    {
        ...
        self::$logger->debug("Return Type : \CyberSourceApi\Model\ReportingV3NetFundingsGet200Response");
        // make the API Call
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\CyberSourceApi\Model\ReportingV3NetFundingsGet200Response',
                '/reporting/v3/net-fundings'
            );
            
            self::$logger->debug("Response Headers :\n" . \CyberSourceApi\Utilities\Helpers\ListHelper::toString($httpHeader));

            return [$this->apiClient->getSerializer()->deserialize($response, '\CyberSourceApi\Model\ReportingV3NetFundingsGet200Response', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\CyberSourceApi\Model\ReportingV3NetFundingsGet200Response', $e->getResponseHeaders());
