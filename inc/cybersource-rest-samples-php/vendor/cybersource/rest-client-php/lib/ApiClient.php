...
class ApiClient
{
     ...
     */
    public function __construct(\CyberSourceApi\Configuration $config = null, \CyberSourceApi\Authentication\Core\MerchantConfiguration $merchantConfig = null)
    {
        if ($config === null) {
        ...
        if (self::$logger === null) {
            self::$logger = (new LogFactory())->getLogger(\CyberSourceApi\Utilities\Helpers\ClassHelper::getClassName(get_class()), $merchantConfig->getLogConfiguration());
        }
    }
     ...
     *
     * @throws \CyberSourceApi\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\CyberSourceApi\ObjectSerializer::sanitizeForSerialization($postData));
        }
        ...
        self::$logger->debug("Request Headers :\n" . \CyberSourceApi\Utilities\Helpers\DataMasker::maskAuthenticationData(\CyberSourceApi\Utilities\Helpers\ListHelper::toString($requestHeaders)));
        ...
        if ($this->merchantConfig->getLogConfiguration()->isMaskingEnabled()) {
            $printPostData = \CyberSourceApi\Utilities\Helpers\DataMasker::maskData($postData);
        } else {
        ...
        if (!isset($this->downloadFilePath) && trim($this->downloadFilePath ?? '') == '') {
            ...
            if ($this->merchantConfig->getLogConfiguration()->isMaskingEnabled()) {
                $printHttpBody = \CyberSourceApi\Utilities\Helpers\DataMasker::maskData($http_body);
            } else {
