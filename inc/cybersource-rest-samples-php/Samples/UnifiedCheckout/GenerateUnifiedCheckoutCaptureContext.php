...
function GenerateUnifiedCheckoutCaptureContext()
{
    ...
    $orderInformationAmountDetails = new CyberSourceApi\Model\Upv1capturecontextsOrderInformationAmountDetails($orderInformationAmountDetailsArr);

    $orderInformationArr = [
            "amountDetails" => $orderInformationAmountDetails
    ];
    $orderInformation = new CyberSourceApi\Model\Upv1capturecontextsOrderInformation($orderInformationArr);
    ...
    $captureMandate = new CyberSourceApi\Model\Upv1capturecontextsCaptureMandate($captureMandateArr);
    ...
    $requestObj = new CyberSourceApi\Model\GenerateUnifiedCheckoutCaptureContextRequest($requestObjArr);
    ...
    $apiInstance = new CyberSourceApi\Api\UnifiedCheckoutCaptureContextApi($apiClient);
