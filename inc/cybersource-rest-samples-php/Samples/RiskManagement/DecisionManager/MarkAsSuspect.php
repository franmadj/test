...
function MarkAsSuspect()
{
    ...
    $riskInformationMarkingDetails = new CyberSourceApi\Model\Riskv1decisionsidmarkingRiskInformationMarkingDetails($riskInformationMarkingDetailsArr);

    $riskInformationArr = [
            "markingDetails" => $riskInformationMarkingDetails
    ];
    $riskInformation = new CyberSourceApi\Model\Riskv1decisionsidmarkingRiskInformation($riskInformationArr);
    ...
    $requestObj = new CyberSourceApi\Model\FraudMarkingActionRequest($requestObjArr);
