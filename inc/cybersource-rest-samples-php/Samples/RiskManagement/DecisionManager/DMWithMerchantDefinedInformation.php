...
function DMWithMerchantDefinedInformation()
{
    ...
    $merchantDefinedInformation[0] = new CyberSourceApi\Model\Riskv1decisionsMerchantDefinedInformation($merchantDefinedInformation_0);

    $merchantDefinedInformation_1 = [
            "key" => "2",
            "value" => "Test2"
    ];
    $merchantDefinedInformation[1] = new CyberSourceApi\Model\Riskv1decisionsMerchantDefinedInformation($merchantDefinedInformation_1);
