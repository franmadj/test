...
function DMWithDecisionProfileRejectResponse()
{
    ...
    $riskInformationProfile = new CyberSourceApi\Model\Ptsv2paymentsRiskInformationProfile($riskInformationProfileArr);

    $riskInformationArr = [
            "profile" => $riskInformationProfile
    ];
    $riskInformation = new CyberSourceApi\Model\Riskv1decisionsRiskInformation($riskInformationArr);
