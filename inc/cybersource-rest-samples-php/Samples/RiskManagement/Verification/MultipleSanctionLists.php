...
function MultipleSanctionLists()
{
    ...
    $orderInformationBillToCompany = new CyberSourceApi\Model\Riskv1exportcomplianceinquiriesOrderInformationBillToCompany($orderInformationBillToCompanyArr);
    ...
    $deviceInformation = new CyberSourceApi\Model\Riskv1exportcomplianceinquiriesDeviceInformation($deviceInformationArr);
