...
function VoidCommittedTaxCall()
{
    ...
    $clientReferenceInformation = new CyberSourceApi\Model\Vasv2taxidClientReferenceInformation($clientReferenceInformationArr);

    $requestObjArr = [
            "clientReferenceInformation" => $clientReferenceInformation
    ];
    $requestObj = new CyberSourceApi\Model\VoidTaxRequest($requestObjArr);
