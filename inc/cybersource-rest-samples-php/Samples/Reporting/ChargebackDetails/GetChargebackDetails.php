...
function GetChargebackDetails()
{
    ...
    $apiInstance = new CyberSourceApi\Api\ChargebackDetailsApi($apiClient);

    try {
        $apiResponse = $apiInstance->getChargebackDetails($startTime, $endTime, $organizationId);
        print_r(PHP_EOL);
        print_r($apiResponse);
