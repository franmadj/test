...
function CreateAdhocReport()
{
    ...
    $reportPreferences = new CyberSourceApi\Model\Reportingv3reportsReportPreferences($reportPreferencesArr);
    ...
    $requestObj = new CyberSourceApi\Model\CreateAdhocReportRequest($requestObjArr);
    ...
    $api_instance = new CyberSourceApi\Api\ReportsApi($api_client);
