...
function CreateCustomerNonDefaultShippingAddress()
{
    ...
    $shipTo = new CyberSourceApi\Model\Tmsv2customersEmbeddedDefaultShippingAddressShipTo($shipToArr);

    $requestObjArr = [
            "_default" => false,
            "shipTo" => $shipTo
    ];
    $requestObj = new CyberSourceApi\Model\PostCustomerShippingAddressRequest($requestObjArr);
    ...
    $api_instance = new CyberSourceApi\Api\CustomerShippingAddressApi($api_client);
