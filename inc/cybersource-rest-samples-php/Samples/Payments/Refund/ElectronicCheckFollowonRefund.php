...
function ElectronicCheckFollowonRefund()
{
    ...
    $processingInformation = new CyberSourceApi\Model\Ptsv2paymentsidrefundsProcessingInformation($processingInformationArr);
    ...
    $requestObj = new CyberSourceApi\Model\RefundPaymentRequest($requestObjArr);
