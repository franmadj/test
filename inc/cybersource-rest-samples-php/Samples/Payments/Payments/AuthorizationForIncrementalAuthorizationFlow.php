...
function AuthorizationForIncrementalAuthorizationFlow()
{
    ...
    $merchantInformationMerchantDescriptor = new CyberSourceApi\Model\Ptsv2paymentsMerchantInformationMerchantDescriptor($merchantInformationMerchantDescriptorArr);

    $merchantInformationArr = [
            "merchantDescriptor" => $merchantInformationMerchantDescriptor
    ];
    $merchantInformation = new CyberSourceApi\Model\Ptsv2paymentsMerchantInformation($merchantInformationArr);
    ...
    $installmentInformation = new CyberSourceApi\Model\Ptsv2paymentsInstallmentInformation($installmentInformationArr);
    ...
    $travelInformationLodgingRoom[0] = new CyberSourceApi\Model\Ptsv2paymentsTravelInformationLodgingRoom($travelInformationLodgingRoom_0);

    $travelInformationLodgingRoom_1 = [
            "dailyRate" => "11.50",
            "numberOfNights" => 5
    ];
    $travelInformationLodgingRoom[1] = new CyberSourceApi\Model\Ptsv2paymentsTravelInformationLodgingRoom($travelInformationLodgingRoom_1);
    ...
    $travelInformationLodging = new CyberSourceApi\Model\Ptsv2paymentsTravelInformationLodging($travelInformationLodgingArr);

    $travelInformationArr = [
            "duration" => "3",
            "lodging" => $travelInformationLodging
    ];
    $travelInformation = new CyberSourceApi\Model\Ptsv2paymentsTravelInformation($travelInformationArr);

    $promotionInformationArr = [
            "additionalCode" => "999999.99"
    ];
    $promotionInformation = new CyberSourceApi\Model\Ptsv2paymentsPromotionInformation($promotionInformationArr);
