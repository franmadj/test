...
function LevelIIIData($flag)
{
    ...
    $orderInformationLineItems[0] = new CyberSourceApi\Model\Ptsv2paymentsOrderInformationLineItems($orderInformationLineItems_0);

    $orderInformationInvoiceDetailsArr = [
            "purchaseOrderNumber" => "LevelIII Auth Po"
    ];
    $orderInformationInvoiceDetails = new CyberSourceApi\Model\Ptsv2paymentsOrderInformationInvoiceDetails($orderInformationInvoiceDetailsArr);
