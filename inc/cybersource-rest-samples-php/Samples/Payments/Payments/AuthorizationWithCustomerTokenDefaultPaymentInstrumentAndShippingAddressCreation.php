...
function AuthorizationWithCustomerTokenDefaultPaymentInstrumentAndShippingAddressCreation()
{
    ...
    $tokenInformationPaymentInstrument = new CyberSourceApi\Model\Ptsv2paymentsTokenInformationPaymentInstrument($tokenInformationPaymentInstrumentArr);

    $tokenInformationShippingAddressArr = [
            "_default" => true
    ];
    $tokenInformationShippingAddress = new CyberSourceApi\Model\Ptsv2paymentsTokenInformationShippingAddress($tokenInformationShippingAddressArr);
