...
function AuthorizationWithDecisionManagerMerchantDefinedInformation()
{
    ...
    $merchantDefinedInformation[0] = new CyberSourceApi\Model\Ptsv2paymentsMerchantDefinedInformation($merchantDefinedInformation_0);

    $merchantDefinedInformation_1 = [
            "key" => "2",
            "value" => "Test2"
    ];
    $merchantDefinedInformation[1] = new CyberSourceApi\Model\Ptsv2paymentsMerchantDefinedInformation($merchantDefinedInformation_1);
