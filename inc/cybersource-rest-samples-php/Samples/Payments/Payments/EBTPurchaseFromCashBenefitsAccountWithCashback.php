...
function EBTPurchaseFromCashBenefitsAccountWithCashback()
{
...
if(!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nEBTPurchaseFromCashBenefitsAccountWithCashback Sample Code is Running..." . PHP_EOL;
    EBTPurchaseFromCashBenefitsAccountWithCashback();
}
?>