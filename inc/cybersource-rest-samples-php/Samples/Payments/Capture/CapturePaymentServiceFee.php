...
function CapturePaymentServiceFee()
{
    ...
    $merchantInformationServiceFeeDescriptor = new CyberSourceApi\Model\Ptsv2paymentsMerchantInformationServiceFeeDescriptor($merchantInformationServiceFeeDescriptorArr);

    $merchantInformationArr = [
            "serviceFeeDescriptor" => $merchantInformationServiceFeeDescriptor
    ];
    $merchantInformation = new CyberSourceApi\Model\Ptsv2paymentsidcapturesMerchantInformation($merchantInformationArr);
