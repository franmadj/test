...
function CreateWebhookUsingOAuthWithJWT()
{
    ...
    $securityPolicyConfigAdditionalConfig = new CyberSourceApi\Model\Notificationsubscriptionsv1webhooksSecurityPolicy1ConfigAdditionalConfig($securityPolicyConfigAdditionalConfigArr);
    ...
    $securityPolicyConfig = new CyberSourceApi\Model\Notificationsubscriptionsv1webhooksSecurityPolicy1Config($securityPolicyConfigArr);
