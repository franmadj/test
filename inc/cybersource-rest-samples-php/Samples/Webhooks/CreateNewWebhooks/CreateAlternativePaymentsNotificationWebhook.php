...
function CreateAlternativePaymentsNotificationWebhook()
{
    $eventTypes = array();
    $eventTypes[0] = "payments.payments.updated";
    $retryPolicyArr = [
...
if(!defined('DO_NOT_RUN_SAMPLES')) {
    echo "\nCreateAlternativePaymentsNotificationWebhook Sample Code is Running..." . PHP_EOL;
    CreateAlternativePaymentsNotificationWebhook();
}
?>