...
function UpdateWebhook($webhookId)
{
    ...
    $notificationScope = new CyberSourceApi\Model\Notificationsubscriptionsv1webhooksNotificationScope($notificationScopeArr);
    ...
    $requestObj = new CyberSourceApi\Model\UpdateWebhookRequest($requestObjArr);
