...
function ReplayFailedTransactionsInLast24Hours($webhookId)
{
    ...
    $byDeliveryStatus = new CyberSourceApi\Model\Nrtfv1webhookswebhookIdreplaysByDeliveryStatus($byDeliveryStatusArr);

    $requestObjArr = [
            "byDeliveryStatus" => $byDeliveryStatus
    ];
    $requestObj = new CyberSourceApi\Model\ReplayWebhooksRequest($requestObjArr);
