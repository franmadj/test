...
class PaytronixApi {
    ...
    public function __construct($card, $cardConfig, $orderId) {
        $this->log('__construct with $card, $cardConfig, $orderId: ' . $orderId);
        ...
        $this->posTransactionId = (string) $orderId;
    ...
    public function setPostFields() {
        ...
        $data = [
            'authentication' => 'b2b',
            'headerInfo' => [
                'posTransactionId' => (string) $this->posTransactionId,
        ...
        $this->log('Data: ' . $this->postFields);
    }

    function activationRequest_() {
        $this->log('activationRequest_ ' . print_r($this->card, true));
        $result = new stdClass();
    ...
    public function activationRequest() {
        $this->log('activationRequest ' . print_r($this->card, true));
