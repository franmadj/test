                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                                        ...
                                                                        <tr>
                                                                            <td align="center">
                                                                                <span style="color: #8C908E; font-size: 20px; line-height: 32px; font-weight: 300; letter-spacing: 1.5px;">From: <?php echo get_post_meta($this->orderId, '_billing_first_name', true) . ' ' . get_post_meta($this->orderId, '_billing_last_name', true); ?></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="center">
