                                            ...
                                            <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        ?>
                                                        <img src="<?= $card_image; ?>" data-img="" 
                                                             alt="A gift for you; an eCard from Texas de Brazil!" style="border-radius: 7px; display: block;width: 80%;">
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        ...
                                        <tr>
                                            <td>
                                                <table width="600" cellspacing="0" cellpadding="0" bgcolor="#FFFBF5" class="100p">
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <span style="color: #8C908E; font-size: 20px; line-height: 32px; font-weight: 300; letter-spacing: 1.5px;">From: <?= $this->order->get_billing_first_name(); ?></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center">
