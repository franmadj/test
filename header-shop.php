...
<head>
    <script id="Cookiebot" src="https://consent.cookiebot.com/uc.js" data-cbid="a592a23f-3be6-4457-8777-ce34b8ee2ff0" data-blockingmode="auto" data-cfasync="false" type="text/javascript"></script>
  ...
  <link rel="apple-touch-icon" sizes="57x57" href="<?php echo get_template_directory_uri()?>/assets/img/favicons/apple-touch-icon-57x57.png">
    ...
    <link rel="icon" type="image/png" href="<?php echo get_template_directory_uri()?>/assets/img/favicons/android-chrome-192x192.png" sizes="192x192">
...
<!--    <link rel="manifest" href="/manifest.json">-->
    ...
    <meta property="og:url" content="" itemprop="url">
    <meta property="og:title" content="" itemprop="name">

    <meta property="og:description" content="" itemprop="description">

    <meta property="og:image" content="" itemprop="image">
    <meta property="article:published_time" content="" itemprop="datePublished">
    <meta property="article:modified_time" content="" itemprop="dateModified">
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.css">
   <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito">
   <?php
        echo get_field('truevault_polaris_code_block', 'options');
        ?>
	<?php wp_head(); ?>
	<?php the_field('typekit','options');?>
	<?php the_field('header_resources','options');?>
</head>
<?php global $post;?>
<body id="tdb-body" class="<?php echo get_post_field( 'post_name', $post->ID); if(is_shop()): echo get_field('body_class',get_option( 'woocommerce_shop_page_id' ));else:echo get_field('body_class',$post->ID);endif;?> " >
	<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-54FSDC5"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
<div class="animsition">
    <?php include(get_template_directory().'/_includes/mobile-header.php');?>
    <?php include(get_template_directory().'/_includes/desktop-header.php');?>
	<main class="main <?php if(get_field('main_class',$post->ID)):echo get_field('main_class',$post->ID);else: echo 'main--interior shop-interior';endif;?>" data-ref="main" id="main-content">
