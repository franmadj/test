...
<?php global $post;?>
<body id="tdb-body" class="body--checkout" >
	<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-54FSDC5"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
    <main class="main" id="main-content">
        <div class="c-minimal-header">
            <a href="/cart/" class="button button--alternate c-minimal-header__back checkout-back-cart">Back to Cart</a>
            <img src="/assets/img/logos/TDB-01.png" class="c-minimal-header__logo" width="450px" alt="Texas de Brazil">
        </div>
