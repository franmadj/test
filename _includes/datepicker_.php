...
<div id="myDatepicker" class="datepicker-wai">
    <div class="date">
        ...
        <input type="text"
               class="c-box__input"
               name="<?php echo !empty($input_name) ? $input_name : 'startDate'; ?>"
               placeholder="<?php echo !empty($placeholder) ? $placeholder : 'mm/dd/yyyy'; ?>"
               id="<?php echo !empty($input_id) ? $input_id : 'id-textbox-1'; ?>"
               
               data-el="<?php echo !empty($data_el) ? $data_el : 'tableFinderDate'; ?>"
