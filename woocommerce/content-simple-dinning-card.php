...
<form class="variations_form cart" action="<?php the_permalink(); ?>" method="post" enctype="multipart/form-data" data-product_id="<?php echo get_the_ID(); ?>" data-ref="productForm">
    ...
    <div class="u-tab" data-ref="tab" data-title="Customize Your E-Gift Card" data-step="1">
        ...
        <div class="u-desktop-row" data-ref="desktopRow">
            ...
            <div class="c-card-options">
                <div class="c-option">
                    <span class="c-option__heading">Price</span>
            ...
            <div class="u-card-body">
                ...
                <div class="tab-links" role="tablist" aria-label="info-use">
                    <a href="javascript:void(0);" class="info-tab tab-link active" data-href="#info-tab" id="info-tab-" type="button" role="tab" aria-selected="true" aria-controls="info-tab">Product Info</a>
                    <a href="javascript:void(0);" class="rule-tab tab-link" data-href="#rule-tab" id="rule-tab-" type="button" role="tab" aria-selected="false" aria-controls="rule-tab" tabindex="-1">Additional Info</a>
                </div>
            ...
            <div class="u-desktop-preview">
                ...
                <button id="e-gift-card-1"  class="button c-card-form__submit u-cart single_add_to_cart_button button alt wc-variation-selection-needed u-confirm-options">Add to Cart</button>
            </div>
    ...
    <div class="u-tab u-tab--disabled" data-ref="tab" data-title="<?php echo $tabTitle; ?>" data-step="2">
        ...
        <input type="hidden" name="add-to-cart" value="<?php echo get_the_ID(); ?>">
        <input type="hidden" name="product_id" value="<?php echo get_the_ID(); ?>">
        <button id="e-gift-card"  class="button c-card-form__submit u-cart single_add_to_cart_button button alt wc-variation-selection-needed">Add to Cart</button>
    </div>
</form>
<script>
