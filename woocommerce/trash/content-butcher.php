    ...
    <div class="u-tab" <?php if (get_field('digital_product') == true): ?> data-ref="tab" data-title="Customize Your E-Gift Card" data-step="1" <?php endif; ?>>
        ...
        <div class="u-desktop-row" data-ref="desktopRow">
            ...
            <div class="u-card-body" role="tablist" aria-label="info-use">
                <a href="javascript:void(0);" class="info-tab tab-link active" data-href="#info-tab" id="info-tab" type="button" role="tab" aria-selected="true" aria-controls="info-use">Product Info</a>
                <a href="javascript:void(0);" class="rule-tab tab-link" data-href="#rule-tab" id="rule-tab" type="button" role="tab" aria-selected="false" aria-controls="info-use">Additional Info</a>
