        ...
        <div class="u-desktop-row" data-ref="desktopRow">
            ...
            <div class="c-card-options">
                <div class="c-option">
                    ...
                    <div class="option-price">$64.99</div>
                    <input type="hidden" name="attribute_varient" value="64.99">
                    <input type="hidden" name="variation_id" value="23575">
                    
<!--                        <select name="attribute_varient" data-attribute_name="attribute_varient">
                    <?php
            ...
            <div class="u-card-body">
                ...
                <div class="tab-links" role="tablist" aria-label="info-use">
                            ...
                            <a href="javascript:void(0);" class="rule-tab tab-link custom-border-bottom" data-href="#rule-tab" id="rule-tab-" type="button" role="tab" aria-selected="false" aria-controls="rule-tab" tabindex="-1">Additional Info</a>
                        </div>
