                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td style="border-collapse: collapse;">
                                                                                                            <table cellpadding="0" cellspacing="0" bgcolor="#000000" width="100%">
                                                                                                                        ...
                                                                                                                        <table cellpadding="0" cellspacing="0" bgcolor="#000000">
                                                                                                                            <tr>
                                                                                                                                ...
                                                                                                                                <td style="border-collapse: collapse;">
                                                                                                                                    ...
                                                                                                                                    <div>
                                                                                                                                        <span style="color: #8C908E; font-size: 20px; line-height: 24px; text-transform: uppercase;"><?php echo $order->get_id(); ?></span>
                                                                                                                                        <br /><br />
                                                                                                                                            ...
                                                                                                                                            <table cellpadding="0" cellspacing="0" bgcolor="#000000" width="100%">
                                                                                                                                                <tr>
                                                                                                                                                    ...
                                                                                                                                                    <td style="border-collapse: collapse;">
                                                                                                                                                        ...
                                                                                                                                                        <div style="color: #8C908E; font-size: 13px; line-height: 15px;">E-CARD NUMBER</div>
                                                                                                                ...
                                                                                                                <?php
                                                                                                                global $wpdb;
                                                                                                               $result = $wpdb->get_row("SELECT *  FROM ".$wpdb->prefix."cronjob WHERE  order_id='".$order->get_id()."'", ARRAY_A);
