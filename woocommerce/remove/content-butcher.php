...
<a href="/shop/butcher-shop/packages/" class="u-promo-back u-step-back backto-all">Back to Packages Products</a>
...
<form class="variations_form cart variations_form-categories" action="<?php the_permalink(); ?>" method="post" enctype="multipart/form-data" data-product_id="<?php echo get_the_ID(); ?>" >
    <div class="c-page-header">
        <a href="/shop/butcher-shop/packages/" class="back-to-products-all">Back to Packages Products</a>
    ...
    <div class="u-tab" <?php if (get_field('digital_product') == true): ?> data-ref="tab" data-title="Customize Your E-Gift Card" data-step="1" <?php endif; ?>>
        ...
        <div class="u-desktop-row" data-ref="desktopRow">
            ...
            <div class="u-card-body" role="tablist" aria-label="info-use">
                <a href="javascript:void(0);" class="info-tab tab-link custom-border-bottom active" data-href="#info-tab" id="info-tab" type="button" role="tab" aria-selected="true" aria-controls="info-use">Product Info</a>
                <a href="javascript:void(0);" class="rule-tab tab-link custom-border-bottom" data-href="#rule-tab" id="rule-tab" type="button" role="tab" aria-selected="false" aria-controls="info-use">Additional Info</a>

                <div id="info-tab-c" class="active tab-content" role="tabpanel" aria-labelledby="info-tab">
                    <?php the_content(); ?>
                </div>
                <div id="rule-tab-c" class="hide-content tab-content" role="tabpanel" aria-labelledby="rule-tab">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.tab-link').on('click', function (e) {
            e.preventDefault();
            $('.tab-content,.tab-link').removeClass('active').attr('aria-selected','false');
