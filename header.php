...
<html <?php language_attributes(); ?>>
    ...
    <?php global $post; ?>
    <body id="tdb-body" class="<?php
    if (is_shop()): echo get_field('body_class', get_option('woocommerce_shop_page_id'));
    else:
        echo get_field('body_class', $post->ID);
        echo_locations_classes();
    endif;
    ?> <?php if (function_exists('extra_body_class')) extra_body_class(); ?>"  >
        <!-- Google Tag Manager (noscript) -->
        <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-54FSDC5"
                          height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
        <!-- End Google Tag Manager (noscript) -->
        <div class="animsition wrapper-main">
            ...
            <?php if (is_single() && 'specials' == get_post_type()) { ?>

                <main class="main <?php
                if (get_field('main_class', $post->ID)): echo get_field('main_class', $post->ID);
                else: echo 'main--interior shop-interior';
                endif;
                ?>" data-ref="main">
                      <?php } else { ?>
                    <main class="main <?php echo get_field('main_class', $post->ID); ?>" data-ref="main" id="main-content">
