            ...
            <tr>
                ...
                <td width="552" valign="top" style="border-collapse: collapse;">
                    <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                            ...
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Title</span> : <?php echo get_the_title($post_id);?>
                                            <?php echo get_post_meta('joinyemail',$post_id,true).'sdfsd';
                        ...
                        <?php if(get_post_meta($post_id,'joinyemail',true)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Email</span> : <?php echo get_post_meta($post_id,'joinyemail',true);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                         <?php if(get_post_meta($post_id,'firstName',true)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">First Name</span> :  <?php echo get_post_meta($post_id,'firstName',true);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                         <?php if(get_post_meta($post_id,'lastName',true)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Last Name</span> :  <?php echo get_post_meta($post_id,'lastName',true);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                         <?php if(get_post_meta($post_id,'birthdate',true)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Birth Date</span> :  <?php echo get_post_meta($post_id,'birthdate',true);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                         <?php if(get_post_meta($post_id,'anniversary',true)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Anniversary</span> :  <?php echo get_post_meta($post_id,'anniversary',true);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                         <?php if(get_post_meta($post_id,'selectedLocation',true)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Favorite Location</span> :  <?php 
                                            $loc=unserialize(get_post_meta($post_id,'selectedLocation',true));
                                           
                                            echo get_the_title($loc[0]);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                         <?php if(get_post_meta($post_id,'zipcode',true)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Zip Code</span> :  <?php echo get_post_meta($post_id,'zipcode',true);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
