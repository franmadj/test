...
<html xmlns="http://www.w3.org/1999/xhtml">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td style="border-collapse: collapse;">
                                                                                                        ...
                                                                                                        <table cellpadding="0" cellspacing="0" bgcolor="#000000" width="100%" style="margin:auto;width:75%;">
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td colspan="5" style="padding-left: 27px;padding-top: 10px;">
                                                                                                                    <?php
                                                                                                                    foreach ($fields as $key => $val) {
                                                                                                                        if (in_array($key, ['location_website', 'location_email']))
                                                                                                                            continue;
                                                                                                                        if ($key == 'user_name')
                                                                                                                            $key = 'Manager name';
                                                                                                                        if ($key == 'user_email')
                                                                                                                        ...
                                                                                                                        <p style="color:#8c908e;margin: 5px;"><?= $key; ?>: <b><?= $val; ?></b></p>
    <?php } ?>
    ...
    <?php endif; ?>
                                                                                            ...
                                                                                            $wpdb->get_results("SELECT * FROM texas_bonuscard where order_id='" . $order->get_id() . "' and amount=10");
                                                                                            $processedTen = $wpdb->num_rows;
                                                                                            $wpdb->get_results("SELECT * FROM texas_bonuscard where order_id='" . $order->get_id() . "' and amount=25");
