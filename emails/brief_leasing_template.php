                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                        <tr>
                            <td style="border-collapse: collapse;">
                                <span style="font-size: 27px; line-height: 27px; font-family: Helvetica; font-weight: 400; color: #404040;"><?php get_bloginfo('name');?></span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">First Name</span> : <?php echo $_POST['first_name'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['last_name'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Last Name</span> : <?php echo $_POST['last_name'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['email'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Email</span> : <?php echo $_POST['email'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['phone'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Phone</span> : <?php echo $_POST['phone'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['company'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Street Address</span> : <?php echo $_POST['company'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['street_address'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">APT Name Suite</span> : <?php echo $_POST['street_address'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['towncity'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">City</span> : <?php echo $_POST['towncity'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['state'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">State</span> : <?php echo $_POST['state'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['country'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Country</span> : <?php echo $_POST['country'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['postal_code'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Zip Code</span> : <?php echo $_POST['postal_code'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['company'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Company</span> : <?php echo $_POST['company'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['market_of_interest'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Market Interest</span> : <?php echo $_POST['market_of_interest'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['content'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Inquiry</span> : <?php echo $_POST['content'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
