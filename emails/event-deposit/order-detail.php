                                                                                                        ...
                                                                                                        <table cellpadding="0" cellspacing="0" bgcolor="#000000" width="100%" style="margin:auto;width:75%;">
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td width="59" style="border-collapse: collapse;">
                                                                                                                    <span style="color: #FCFBFA; font-size: 20px; line-height: 24px; font-weight: 300;">&nbsp;</span>
                                                                                                                </td>
                                                                                                            ...
                                                                                                            <?php if (!empty($fields) && is_array($fields) && !empty($fields['user_name'])) { ?>
                                                                                                            ...
                                                                                                            <table cellpadding="0" cellspacing="0" bgcolor="#000000" width="100%" style="margin: auto;width: auto;margin-top:25px;">
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="border-collapse: collapse;">
                                                                                                                        ...
                                                                                                                        <div style="color: #8C908E; font-size: 13px; line-height: 15px;text-align:left;margin-bottom:10px;">E-DEPOSIT NUMBER</div>
