                ...
                <td width="552" valign="top" style="border-collapse: collapse;">
                    <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                        ...
                        <tr>
                         ...
                         <?php if(get_post_meta($post_id,'contact_email',true)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Email</span> : <?php echo get_post_meta($post_id,'contact_email',true);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                         ...
                         $location = unserialize(get_post_meta($post_id,'locationvisited',true));
                       
                         if($location[0]):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Location</span> : <?php echo get_the_title($location[0]);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                         <?php if(get_post_meta($post_id,'date_visited',true)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Date Visited</span> : <?php echo get_post_meta($post_id,'date_visited',true);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                         <?php if(get_post_meta($post_id,'contact_subject',true)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Subject</span> : <?php echo get_post_meta($post_id,'contact_subject',true);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                         <?php if(get_post_field('post_content', $post_id)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Body</span> : <?php echo get_post_field('post_content', $post_id);?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                        ...
                        <tr>
                            <td style="border-collapse: collapse;">
                                <span style="font-size: 13px; line-height: 21px; font-family: Helvetica; font-style: italic; color: #B0ADAB;">&nbsp;This was sent automatically by your website. Turn off notifications <a href="https://texasdebrazil.com/wp-admin" style="color: #B0ADAB;">here</a>.</span>
                            </td>
                        </tr>
                    </table>
                </td>
