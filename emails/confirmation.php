                            ...
                            <tr>
                                <td>
                                    <table width="600" cellpadding="0" cellspacing="0" bgcolor="#000000" class="100p">
                                        ...
                                        <tr>
                                            <td align="center" style="border-collapse: collapse;">
                                                <span style="font-size: 32px; line-height: 38px; font-weight: bold; color: #FFFFFF;">ORDER CONFIRMATION</span>
                                            </td>
                                        </tr>
                                        <tr>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="border-collapse: collapse;">
                                                                                    ...
                                                                                    <div>
                                                                                        ...
                                                                                        <br /><br />
                                                                                        <span style="color: #8C908E; font-size: 12px; line-height: 24px; text-transform: uppercase;">Ordered on {{ order.dateOrdered|date('F j, Y') }}</span>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td style="border-collapse: collapse;">
                                                                                    <span style="color: #B9B7B2; font-size: 15px; line-height: 24px;">
                                                                                        ...
                                                                                        {{ method.name|default }}
                                                                                        {% if order.signatureOption | length %}{{ order.signatureOption }}{% endif %}
                                                                                    </span>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
