            ...
            <tr>
                ...
                <td width="552" valign="top" style="border-collapse: collapse;">
                    <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                        ...
                        <?php endif;?>
                        <?php if($_POST['lastName'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Last Name</span> : <?php echo $_POST['lastName'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['na_email'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Email</span> : <?php echo $_POST['na_email'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['na_phone'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Phone</span> : <?php echo $_POST['na_phone'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['address1'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Street Address</span> : <?php echo $_POST['address1'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['address2'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">APT Name Suite</span> : <?php echo $_POST['address2'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['na_city'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">City</span> :<?php echo $_POST['na_city'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        ...
                        <?php endif;?>
                        <?php if($_POST['zip_code'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Zip Code</span> : <?php echo $_POST['zip_code'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
                        <?php if($_POST['inquiry'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Inquiry</span> : <?php echo $_POST['inquiry'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif;?>
