            ...
            <tr>
                ...
                <td width="552" valign="top" style="border-collapse: collapse;">
                    <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                            ...
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Title</span> : <?php echo $_POST['first_name'].' '.$_POST['last_name'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($_POST['contact_email'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Email</span> : <?php echo $_POST['contact_email'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($_POST['contact_phone'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Phone</span> : <?php echo $_POST['contact_phone'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                        ...
                        <?php endif; ?>
                        <?php if(get_field('attach_document',$post_id)):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Document</span> : <a href="<?php echo wp_get_attachment_url(get_field('attach_document',$post_id) );?>" download>Download</a>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
                        <?php if($_POST['content'] !=""):?>
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Message</span> : <?php echo $_POST['content'];?>
                                    </span>
                                </td>
                            </tr>
                        <?php endif; ?>
