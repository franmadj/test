                    ...
                    <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                        ...
                        <tr>
                            <td style="border-collapse: collapse;">
                                <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            Hey, there! A new <span style="font-weight: bold;">{{ sectionTitle }}</span> has been added. Following are its details:
                                </span>
                            </td>
                        </tr>
                        ...
                        {% if entry.email | length %}
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Email</span> : {{ entry.email }}
                                    </span>
                                </td>
                            </tr>
                        {% endif %}
                        {% if entry.locationVisited | length %}
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Location</span> : {{ entry.locationVisited.first().title }}
                                    </span>
                                </td>
                            </tr>
                        {% endif %}
                        {% if entry.dateVisited | length %}
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Date Visited</span> : {{ entry.dateVisited }}
                                    </span>
                                </td>
                            </tr>
                        {% endif %}
                        {% if entry.subject | length %}
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Subject</span> : {{ entry.subject }}
                                    </span>
                                </td>
                            </tr>
                        {% endif %}
                        {% if entry.body | length %}
                            <tr>
                                <td style="border-collapse: collapse;">
                                    <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            <span style="font-weight: bold;">Body</span> : {{ entry.body }}
                                    </span>
                                </td>
                            </tr>
                        {% endif %}
                        ...
                        <tr>
                            <td style="border-collapse: collapse;">
                                <div><!--[if mso]>
                      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ entryUrl }}" style="height:45px;v-text-anchor:middle;width:200px;" arcsize="100%" stroke="f" fillcolor="#E15718">
                        <w:anchorlock/>
                        <center>
                      <![endif]-->
                          <a href="{{ entryUrl }}" style="background-color:#E15718;border-radius:60px;color:#ffffff;display:inline-block;font-family:Helvetica Neue;font-size:19px;font-weight:400;line-height: 45px;text-align:center;text-decoration:none;width: 200px;-webkit-text-size-adjust:none;">View the entry</a>
                      <!--[if mso]>
                        </center>
                      </v:roundrect>
                    <![endif]--></div>
                      ...
                      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ entryUrl }}" style="height:45px;v-text-anchor:middle;width:200px;" arcsize="100%" stroke="f" fillcolor="#E15718">
                        ...
                        <center>
                      <![endif]-->
                          <a href="mailto:{{ entry.email }}" style="background-color:#E15718;border-radius:60px;color:#ffffff;display:inline-block;font-family:Helvetica Neue;font-size:19px;font-weight:400;line-height: 45px;text-align:center;text-decoration:none;width: 200px;-webkit-text-size-adjust:none;">Reply</a>
                      <!--[if mso]>
                        </center>
                      </v:roundrect>
                    <![endif]--></div>
