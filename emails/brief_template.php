                        ...
                        <tr>
                            <td style="border-collapse: collapse;">
                                <span style="font-size: 19px; line-height: 28px; font-family: Helvetica; color: #242424;">
                                            Hey, there! There's been an update or addition to the <span style="font-weight: bold;">{{ sectionTitle }}</span> Section. You can view it in the CMS <a href="{{ entryUrl }}" style="color: #E15718;">here</a>.
                                </span>
                            </td>
                        </tr>
                        <tr>
